  ...
  return (
    <main>
      ...
      <footer>
        ...
        <div><p className="footer-label">Adres</p><p>Zafer Mahallesi, Adile Naşit Bulvarı<br />Gümüş Panorama Çarşı, K Blok<br />Esenyurt / İstanbul</p></div>
        ...
        <div><p className="footer-label">Hızlı bağlantı</p><a href="#davetler">Davetler</a><a href="#galeri">Galeri</a><a href={whatsapp("Merhaba Karam Event Hall, bilgi almak istiyorum.")} target="_blank" rel="noreferrer">WhatsApp</a></div>
